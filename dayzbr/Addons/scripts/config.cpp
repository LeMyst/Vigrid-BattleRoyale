...
class CfgLoot
{
	class Weapons
	{
		...
		Gear_4[] = {"M4A1","M68Optic","Mag_STANAG_30Rnd"};
		Gear_5[] = {"M4A1","M68Optic","Mag_STANAG_30Rnd"};
		...
		Gear_16[] = {"MakarovPB","Mag_MakarovPB_8Rnd","Mag_MakarovPB_8Rnd"};
	...
	class Gear 
	{
		...
		Gear_4[] = {"GorkaPants_PautRev","GorkaEJacket_PautRev","HighCapacityVest_Black"};
		...
		Gear_9[] = {"MedicalScrubsPants_White","MedicalScrubsPants_White","MedicalScrubsHat_White"};
		...
		Gear_17[] = {"GorkaHelmetComplete","M65Jacket_Black","ImprovisedBag"};
	};
	...
	{
		num_items = 1;
		Gear_1[] = {"PeachesCan_Opened","PeachesCan_Opened","FNX45","Mag_FNX45_15Rnd","Mag_FNX45_15Rnd","WaterBottle"};
		Gear_2[] = {"AK_Suppressor","PeachesCan_Opened","FNX45","Mag_FNX45_15Rnd","Mag_FNX45_15Rnd","WaterBottle"};
		Gear_3[] = {"M4_Suppressor","PeachesCan_Opened","FNX45","Mag_FNX45_15Rnd","Mag_FNX45_15Rnd","WaterBottle"};
	};
};